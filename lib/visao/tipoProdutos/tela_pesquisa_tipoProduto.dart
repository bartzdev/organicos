...
class TelaPesquisaTipoProduto extends StatefulWidget{
  _TelaPesquisaTipoProdutoState createState()=> _TelaPesquisaTipoProdutoState();
}
    ...
    return Container(
       decoration: BoxDecoration(
            ...
            child: ListTile(
              title: Row(children: [
                Expanded(
                  child: Text(tipo.nome == null ? '' : tipo.nome!,
              ...
              onPressed: () async {
                ...
                _controle.carregarDados(tipo).then((value) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TelaCadastroTipoProdutos(_controle, onSaved: () {
                                setState(() {
                              ...
                              onPressed: () {
                                ...
                                _controle.carregarDados(tipo).then((value) {
                                  ...
                                  _controle.excluirObjetoCadastroEmEdicao().then((_) {
                                    ...
                                    setState(() {
                                      _controle.listaObjetosPesquisados?.remove(tipo);
                                    });
                                  });
                                });
                              },
